...
contract ERC948 {
    ...
    function subscribe(
        ...
        require(_tokenAddress != address(0), "Token Address must exist");
        require(
            _initialPayment >= 0,
            "Initial Payment must be zero or positive integer"
        );
        require(
            _paymentPerPeriod > 0,
        ...
        require(
            token.allowance(msg.sender, serviceProviderAddress) >=
                amountRequired,
